 ...
 * TODO: Cambiar cliclo de validacion de usuario
 * TODO: Cambiar a jquery?
 * TODO: Centralizar funciones compartidas
 * TODO: Reducir Peso
 */
session_start(); 
...
<div id='registro'>
	...
	?>
	<form id='login_usuario' name='login_usuario' action='inc/validacion.php' method='post' >
		<table width='50%' class="login">
		<tr><th colspan='2'>Acceso Usuarios</th></tr>
  		<tr>
  			<td align='right'>
				Usuario:
			</td>
		...
		<td>
			<input type='password' id="password" name="password" accesskey="c" tabindex="2" />
		</td>
		</tr>
		<tr>
  ...
  <div id='footer'>
  	<span class="etiqueta">Desarrollado por:</span><br/>
